...
public class PdfView extends AbstractPdfView {
    ...
    private PdfPTable createTableInfos() throws DocumentException {
        ...
        cellulesInfos[2] = new PdfPCell(new Phrase("Boulevard de la Meuse 142", fontInfo));
        ...
        cellulesInfos[4] = new PdfPCell(new Phrase("5100 Jambes", fontInfo));
        ...
        cellulesInfos[7] = new PdfPCell(new Phrase(client().getPhoneNumber(), fontInfo));
        ...
        cellulesInfos[9] = new PdfPCell(new Phrase(client().getMail(), fontInfo));
    ...
    private Paragraph createTitle() {
        Chunk title = new Chunk("Facture N°" + invoice.getCode());
    ...
    private PdfPTable createTableDonnees() throws DocumentException {
        ...
        for (int j = 0; j < nombreLignesinvoices(); j++) {
            ...
            cellulesDonnees[numCell] = new PdfPCell(new Phrase(documentLine(j).getUnit().getUnit(), fontInfo));
            cellulesDonnees[numCell].setBorder(0);
        ...
        for (int i = 0; i < 6; i++) {
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    cellulesTotaux[i] = new PdfPCell(new Phrase(twoDecimals.format(invoice.subTotal()) + " EUR", fontTitre));
                    cellulesTotaux[i].setBorder(0);
                ...
                case 4:
                    ...
                    break;
                case 5:
                    cellulesTotaux[i] = new PdfPCell(new Phrase(twoDecimals.format(invoice.total()) + " EUR", fontTitre));
                    cellulesTotaux[i].setBorder(0);
                    cellulesTotaux[i].setHorizontalAlignment(ALIGN_RIGHT);
                    cellulesTotaux[i].setVerticalAlignment(ALIGN_MIDDLE);
                    cellulesTotaux[i].setMinimumHeight(MIN_HEIGHT);
...
//        String dateString = date.toString(dateFormatter);
        ...
        Phrase phraseDate = new Phrase("Namur, le " + dt.format(date));
